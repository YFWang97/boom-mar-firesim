...
IF (WITH_BOOST)
  ...
  IF(NOT LOCAL_BOOST_DIR OR LOCAL_BOOST_DIR STREQUAL "LOCAL_BOOST_DIR-NOTFOUND")
    SET(LOCAL_BOOST_DIR "${CMAKE_CURRENT_SOURCE_DIR}/boost/boost_1_73_0" CACHE PATH "Forced Boost dir" FORCE)
    SET(BOOST_INCLUDE_DIR "${LOCAL_BOOST_DIR}" CACHE PATH "Forced Boost include dir" FORCE)
    MESSAGE(STATUS "Forcing LOCAL_BOOST_DIR=${LOCAL_BOOST_DIR}")
  ENDIF()
  IF(LOCAL_BOOST_DIR)
